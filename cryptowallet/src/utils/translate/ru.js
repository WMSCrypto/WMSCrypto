const translates = {
      ...
      "Repeat new password.": "Подтвердите пароль",
      ...
      "Below is the recovery phrase for your wallet. We strongly recommend you to write it down and keep in a safe place.": "Ниже Вы увидите фразу для восстановления кошелька. Рекомендуем записать ее и хранить в надежном месте! В случае потери эта фраза не может быть восстановлена!",

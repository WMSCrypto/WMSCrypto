const translates = {
    ...
    "SAVE_MNEMONICS": "Ниже Вы увидите фразу для восстановления кошелька. Рекомендуем записать ее и хранить в надежном месте! В случае потери эта фраза не может быть восстановлена!",
